...
export const newsData: NewsArticle[] = [
  {
    "id": 8,
    "title": "Logistics AI Hackathon Finalists: RZK Soft Scaling Terminal Innovation",
    "titleUk": "Фіналісти Logistics AI Hackathon: RZK Soft масштабує інновації для терміналів",
    "titleEs": "Finalistas del Logistics AI Hackathon: RZK Soft escala innovaciones logísticas",
    "titleDe": "Finalisten beim Logistics AI Hackathon: RZK Soft skaliert Logistik-Innovationen",
    "titleNl": "Finalisten bij de Logistics AI Hackathon: RZK Soft schaalt logistieke innovaties",
    "excerpt": "RZK Soft reached the finals of the Logistics AI Hackathon by Nova Poshta & DEV Challenge, presenting a high-scale AI system for terminal optimization.",
    "excerptUk": "RZK Soft вийшла у фінал Logistics AI Hackathon від Нової Пошти та DEV Challenge, представивши масштабовану AI-систему для оптимізації терміналів.",
    "excerptEs": "RZK Soft llegó a la final del Logistics AI Hackathon de Nova Poshta, presentando un sistema de IA para la optimización de terminales.",
    "excerptDe": "RZK Soft erreichte das Finale des Logistics AI Hackathons von Nova Poshta und präsentierte ein KI-System zur Terminaloptimierung.",
    "excerptNl": "RZK Soft bereikte de finale van de Logistics AI Hackathon van Nova Poshta en presenteerde een AI-systeem voor terminaloptimalisatie.",
    "content": "Innovation in logistics requires more than just code—it requires scale. RZK Soft recently competed in the Logistics AI Hackathon, organized by Nova Poshta in collaboration with DEV Challenge.\n\nOut of numerous participating teams, we were selected as finalists, presenting a sophisticated Computer Vision system designed to optimize workflows at large-scale logistics terminals. Our solution focused on processing live feeds from up to 1,100 cameras to detect bottlenecks and automate throughput analysis in real-time.\n\nThe event provided a high-level platform for technical exchange with industry leaders from Zibra AI, Vodafone Ukraine, and Nova Poshta’s R&D departments. Beyond the competition, the event opened doors for potential future cooperation with the organizers, acknowledging RZK Soft's expertise in deep-tech and AI implementation.\n\nWe are proud to have been supported by an ecosystem of partners including Diia.Business, SET University, UNIT.City, and the 1991 Accelerator. This milestone reinforces our commitment to building AI tools that solve industrial-scale problems.",
    "contentUk": "Інновації в логістиці потребують більше, ніж просто код — вони потребують масштабу. Команда RZK Soft нещодавно взяла участь у Logistics AI Hackathon, організованому Новою Поштою у колаборації з DEV Challenge.\n\nСеред численних команд ми пройшли до фіналу, представивши складну систему на базі Computer Vision для оптимізації процесів на великих логістичних терміналах. Наше рішення фокусувалося на обробці потоків з понад 1100 камер для виявлення заторів та автоматизації аналізу пропускної здатності в реальному часі.\n\nХакатон став платформою для глибокого технічного обміну з лідерами індустрії з Zibra AI, Vodafone Ukraine та R&D департаментів Нової Пошти. Окрім змагальної частини, участь у фіналі відкрила шлях до потенційної подальшої співпраці з організаторами, які відзначили експертизу RZK Soft у сфері Deep-tech та впровадження ШІ.\n\nМи вдячні за підтримку екосистемі партнерів, серед яких Дія.Бізнес, SET University, UNIT.City та акселератор 1991. Цей етап підтверджує готовність нашої команди вирішувати задачі промислового масштабу.",
    "contentEs": "RZK Soft llegó a la gran final del Logistics AI Hackathon organizado por Nova Poshta y DEV Challenge. Presentamos una solución de visión por computadora capaz de optimizar terminales de gran escala, analizando hasta 1,100 cámaras en tiempo real. Durante el evento, establecimos contactos estratégicos con expertos de Zibra AI y Vodafone, abriendo conversaciones para futuras colaboraciones tecnológicas.",
    "contentDe": "RZK Soft erreichte das Finale des Logistics AI Hackathons von Nova Poshta & DEV Challenge. Wir präsentierten ein Computer-Vision-System zur Optimierung von Logistikterminals, das Daten von bis zu 1.100 Kameras verarbeitet. Der Austausch mit Führungskräften von Zibra AI und Vodafone markiert den Beginn eines Dialogs über zukünftige Partnerschaften.",
    "contentNl": "RZK Soft bereikte de finale van de Logistics AI Hackathon georganiseerd door Nova Poshta en DEV Challenge. We presenteerden een Computer Vision-systeem voor terminaloptimalisatie, geschikt voor het analyseren van 1.100 camera's. Het evenement faciliteerde waardevolle contacten met Zibra AI en Vodafone voor toekomstige samenwerkingen.",
    "date": "2026-03-29",
    "author": "Mykhailo Tymoshenko",
    "category": "Milestones",
    "categoryUk": "Досягнення",
    "categoryEs": "Hitos",
    "categoryDe": "Meilensteine",
    "categoryNl": "Mijlpalen",
    "image": "/images/news/logistics-hackathon1.png",
    "readTime": 2,
    "tags": ["AI", "Hackathon", "Logistics", "Computer Vision", "Nova Poshta"]
  },
  {
    "id": 7,
